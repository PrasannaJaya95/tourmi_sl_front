 ...
 *
 * Use for table cells, list rows, badges and any compact UI date.
 */
 ...
 *
 * Use for created/updated timestamps and other moment-in-time displays.
 */
 ...
 *
 * Use in PDFs, headlines, emphasized labels and report headers.
 */
...
/**
 * Renders a date range like `01/05/2026 → 09/05/2026` (numeric, default)
 * or `01 May 2026 → 09 May 2026` (when `long: true`).
 */
export function formatDateRange(from, to, { long = false, separator = ' → ' } = {}) {
